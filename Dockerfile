...
RUN curl -L -o /app/fuseki/plugins/jena-exectracker-0.7.0.jar \
    ...
    curl -L -o /app/fuseki/plugins/jenax-arq-plugins-bundle-6.0.0-1.jar \
    "https://github.com/Scaseco/jenax/releases/download/v6.0.0-1/jenax-arq-plugins-bundle-6.0.0-1.jar" && \
    curl -L -o /app/fuseki/plugins/jenax-serviceenhancer-preview-plugin-6.0.0-1.jar \
    "https://github.com/Scaseco/jenax/releases/download/v6.0.0-1/jenax-serviceenhancer-preview-plugin-6.0.0-1.jar"
